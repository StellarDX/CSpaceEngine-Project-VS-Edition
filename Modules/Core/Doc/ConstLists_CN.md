...
| HubbleParam     | 哈勃常数   | 68.3             | (±1.5)(单位: (Km/s)/Mpc)SPT在2022-12-12测得的值 |
| HubbleParamSI   | 哈勃常数   | 2.2134522E-18*   | 国际单位制的哈勃常数(单位: 1/s) |
| CosmoDensityRatio| - | 0.6889 | (±0.0056)宇宙常数计算的能量密度与宇宙临界密度之间的比率，这个值是2018年普朗克望远镜的测量值 |
| CosmoConstant   | 宇宙常数   | 1.12661713E-52* | 爱因斯坦引力场方程中的宇宙常数，只在宇宙尺度下有意义 |
...
| HubbleLength    | 哈勃长度 | 1.3544112E+26 | |
