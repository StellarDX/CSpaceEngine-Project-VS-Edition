// arcsin and arccos functions for double precision by IBM
...
_Check_return_ _FType __cdecl arcsin(_In_ _FType _X) { return __asin(_X); }
_Check_return_ _FType __cdecl arccos(_In_ _FType _X) { return __acos(_X); }
...
#define _ConvertUnit
#else
#define _ConvertUnit degrees
#endif

static const union __IBM_Table_Type2568 { uint32_t i[5136]; float64 x[2568]; } __IBM_asncs_table
{ 
    .i = 
    {
...
// x + (1/6)*x^3 + (3/40)*x^5 + (5/112)*x^7 + (35/1152)*x^9 + ... ((2*n)!/(4^n*(n!)^2*(2*n+1)))
__Float64
f1 = 1.66666666666666666666666666666667E-01,
f2 = 7.50000000000000000000000000000000E-02,
f3 = 4.46428571428571428571428571428571E-02,
f4 = 3.03819444444444444444444444444444E-02,
f5 = 2.23721590909090909090909090909091E-02,
f6 = 1.73527644230769230769230769230769E-02;

// 2^n
static const float64 powtwo[]
{
    0x1p+00, 0x1p+01, 0x1p+02, 0x1p+03, 0x1p+04, 0x1p+05, 0x1p+06,
    0x1p+07, 0x1p+08, 0x1p+09, 0x1p+10, 0x1p+11, 0x1p+12, 0x1p+13,
...
static const float64 t24 = 16777216.0, t27 = 134217728.0;
...
_Check_return_ __Float64 __cdecl __IBM_ASINF64(_In_ __Float64 x)
{
    ...
    /* for x->0 => sin(x)=x */
    if (k < 0x3e500000){ return _ConvertUnit(x); }
    /*----------------------2^-26 <= |x| < 2^ -3    -----------------*/
    ...
    else if (k < 0x3fe00000)
    {
        ...
        if (m > 0) { xx = x - __IBM_asncs_table.x[n]; }
        else { xx = -x - __IBM_asncs_table.x[n]; }

        res = __IBM_asncs_table.x[n + 8] + __IBM_asncs_table.x[n + 1] * xx + xx * xx * (__IBM_asncs_table.x[n + 2] + xx * (__IBM_asncs_table.x[n + 3] + xx * (__IBM_asncs_table.x[n + 4] + xx * (__IBM_asncs_table.x[n + 5] + xx * __IBM_asncs_table.x[n + 6])))) + __IBM_asncs_table.x[n + 7];
        /* Max ULP is 0.524.  */
    ...
    else if (k < 0x3fe80000) 
    {
        ...
        res = __IBM_asncs_table.x[n + 9] + __IBM_asncs_table.x[n + 1] * xx + xx * xx * (__IBM_asncs_table.x[n + 2] + xx * (__IBM_asncs_table.x[n + 3] + xx * (__IBM_asncs_table.x[n + 4] + xx * (__IBM_asncs_table.x[n + 5] + xx * (__IBM_asncs_table.x[n + 6] + xx * __IBM_asncs_table.x[n + 7]))))) + __IBM_asncs_table.x[n + 8];
        /* Max ULP is 0.505.  */
        return _ConvertUnit((m > 0) ? res : -res);
    }    /*   else  if (k < 0x3fe80000)    */
    /*--------------------- 0.75 <= |x|< 0.921875 ----------------------*/
    else if (k < 0x3fed8000)
    {
        ...
        res = __IBM_asncs_table.x[n + 10] + __IBM_asncs_table.x[n + 1] * xx + xx * xx * (__IBM_asncs_table.x[n + 2] + xx * (__IBM_asncs_table.x[n + 3] + xx * (__IBM_asncs_table.x[n + 4] + xx * (__IBM_asncs_table.x[n + 5] + xx * (__IBM_asncs_table.x[n + 6] + xx * (__IBM_asncs_table.x[n + 7] + xx * __IBM_asncs_table.x[n + 8])))))) + __IBM_asncs_table.x[n + 9];
        /* Max ULP is 0.505.  */
        return _ConvertUnit((m > 0) ? res : -res);
    }    /*   else  if (k < 0x3fed8000)    */
    /*-------------------0.921875 <= |x| < 0.953125 ------------------------*/
    else if (k < 0x3fee8000)
    {
        ...
        res = __IBM_asncs_table.x[n + 11] + __IBM_asncs_table.x[n + 1] * xx + xx * xx * (__IBM_asncs_table.x[n + 2] + xx * (__IBM_asncs_table.x[n + 3] + xx * (__IBM_asncs_table.x[n + 4] + xx * (__IBM_asncs_table.x[n + 5] + xx * (__IBM_asncs_table.x[n + 6] + xx * (__IBM_asncs_table.x[n + 7] + xx * (__IBM_asncs_table.x[n + 8] + xx * __IBM_asncs_table.x[n + 9]))))))) + __IBM_asncs_table.x[n + 10];
        /* Max ULP is 0.505.  */
        return _ConvertUnit((m > 0) ? res : -res);
    }    /*   else  if (k < 0x3fee8000)    */
    ...
    else if (k < 0x3fef0000)
    {
        ...
        res = __IBM_asncs_table.x[n + 12] + __IBM_asncs_table.x[n + 1] * xx + xx * xx * (__IBM_asncs_table.x[n + 2] + xx * (__IBM_asncs_table.x[n + 3] + xx * (__IBM_asncs_table.x[n + 4] + xx * (__IBM_asncs_table.x[n + 5] + xx * (__IBM_asncs_table.x[n + 6] + xx * (__IBM_asncs_table.x[n + 7] + xx * (__IBM_asncs_table.x[n + 8] + xx * (__IBM_asncs_table.x[n + 9] + xx * __IBM_asncs_table.x[n + 10])))))))) + __IBM_asncs_table.x[n + 11];
        /* Max ULP is 0.505.  */
        return _ConvertUnit((m > 0) ? res : -res);
    }    /*   else  if (k < 0x3fef0000)    */
    /*--------------------0.96875 <= |x| < 1 --------------------------------*/
    else if (k < 0x3ff00000)
    {
        ...
        v = z;
        k = v.parts.msw;
        t = __IBM_inroot_table[(k & 0x001fffff) >> 14] * powtwo[511 - (k >> 21)];
        r = 1.0 - t * t * z;
